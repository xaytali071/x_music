...
//     return Scaffold(
//       body: BlocBuilder<AudioNotifire, AudioState>(
...
//                     selIndex = index;
//                     widget.context.read<AudioNotifire>()
//                       ..onMode()
//                       ..getAudio(
...
//                                 return BlocBuilder<AudioNotifire,
//                                     AudioState>(
//                                     builder: (context, state) {
//                                       return InkWell(
//                                         onTap: () {
...
//                                                                 (context,
//                                                                 snapshot) {
//                                                               if(snapshot.data==widget.context.read<AudioNotifire>().player.duration && selIndex!=state.listOfMusicArtist!.length-1){
//                                                                 widget.context.read<AudioNotifire>()
//                                                                   ..pause()
//                                                                   ..nextMusic(
...
//                                                                       total: widget.context.read<AudioNotifire>().player.duration ?? const Duration(seconds: 0),
//                                                                       onSeek: (duration) {
//                                                                         widget.context.read<AudioNotifire>().seek(duration);
//                                                                       },
//                                                                     ),
//                                                                   );
//                                                                 },
...
//                                                                         .play();
//                                                                     state.isPlay
//                                                                         ? widget.context.read<AudioNotifire>().playy()
//                                                                         : widget.context.read<AudioNotifire>().pause();
//                                                                   },
//                                                                   icon: state.isPlay
//                                                                       ? const Icon(
//                                                                     Icons.pause,
...
//                         });
//                   },
//                   child: BlocBuilder<AudioNotifire, AudioState>(
//                     builder: (context, state) {
